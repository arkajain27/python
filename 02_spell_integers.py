def printText(userInput):
    """This project spells out integers between 0 and 1000000 """
    unitsMapping = {'0':'',
                    '1':' One',
                    '2':' Two',
                    '3':' Three',
...
if __name__ == "__main__":
    userInput = input('Enter an integer smaller than 1000000: ')
    
    while True:
        try:
            userNum = int(userInput)
            if userNum > 999999:
                userInput = input ('Number is too big. Enter an integer smaller than 1000000: ')
            else:
                break
        except ValueError:
            userInput = input('Youd did not enter an integer. Enter an integer smaller than 1000000: ')
